...
public final class CampingDatabase_Impl extends CampingDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `reserva` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `nombreCliente` TEXT NOT NULL, `fechaEntrada` INTEGER NOT NULL, `fechaSalida` INTEGER NOT NULL, `telefonoCliente` TEXT NOT NULL, `precio` REAL NOT NULL)");
        db.execSQL("CREATE INDEX IF NOT EXISTS `index_reserva_id` ON `reserva` (`id`)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '37c106b569fb9a82503ee615b4a60834')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsReserva.put("fechaEntrada", new TableInfo.Column("fechaEntrada", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsReserva.put("fechaSalida", new TableInfo.Column("fechaSalida", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsReserva.put("telefonoCliente", new TableInfo.Column("telefonoCliente", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsReserva.put("precio", new TableInfo.Column("precio", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        final HashSet<TableInfo.ForeignKey> _foreignKeysReserva = new HashSet<TableInfo.ForeignKey>(0);
        final HashSet<TableInfo.Index> _indicesReserva = new HashSet<TableInfo.Index>(1);
        _indicesReserva.add(new TableInfo.Index("index_reserva_id", false, Arrays.asList("id"), Arrays.asList("ASC")));
    ...
    }, "37c106b569fb9a82503ee615b4a60834", "2f34f8a922db23124cfe1e2ac7771786");
