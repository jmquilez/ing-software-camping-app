...
public final class ParcelaReservadaDao_Impl implements ParcelaReservadaDao {
  ...
  @Override
  public void insert(final ParcelaReservada parcelaReservada) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfParcelaReservada.insert(parcelaReservada);
  ...
  @Override
  public void delete(final ParcelaReservada parcelaReservada) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfParcelaReservada.handle(parcelaReservada);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void update(final ParcelaReservada parcelaReservada) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __updateAdapterOfParcelaReservada.handle(parcelaReservada);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void deleteParcelasForReservation(final long reservationId) {
    __db.assertNotSuspendingTransaction();
