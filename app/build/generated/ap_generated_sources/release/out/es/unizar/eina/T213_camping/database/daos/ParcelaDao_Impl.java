...
public final class ParcelaDao_Impl implements ParcelaDao {
  ...
  @Override
  public void insert(final Parcela parcela) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfParcela.insert(parcela);
  ...
  @Override
  public void delete(final Parcela parcela) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __deletionAdapterOfParcela.handle(parcela);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void update(final Parcela parcela) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __updateAdapterOfParcela.handle(parcela);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void deleteByNombre(final String nombre) {
    __db.assertNotSuspendingTransaction();
