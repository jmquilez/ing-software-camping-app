...
public class PriceUtils {
     ...
     * El precio se calcula como: (precio por persona) * (número de ocupantes) * (número de días)
    ...
    public static double calculateReservationPrice(Date checkInDate, Date checkOutDate, 
        ...
        // Add 1 because if you check in on Monday and check out on Tuesday, that's 1 day,
    ...
    public static void updatePriceDisplay(TextView priceDisplay, Date checkInDate, 
        ...
        priceDisplay.setText(String.format(Locale.getDefault(), "Precio total: %.2f€", price));
    }
} 